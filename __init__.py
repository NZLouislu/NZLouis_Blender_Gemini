...
classes = (
    Blender_Gemini_MCP.GeminiImageItem,
    ...
    Blender_Gemini_MCP.GEMINI_OT_send_from_text_editor,
    Blender_Gemini_MCP.GEMINI_OT_install_pillow,
    Blender_Gemini_MCP.GEMINI_OT_copy_response,
